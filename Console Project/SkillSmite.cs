...
{
    internal class SkillSmite : Skill
    {
        public SkillSmite(string skillName, string skillDescription, int skillDamage, int skillMP) : base(skillName, skillDescription, skillDamage, skillMP)
        {
        }
