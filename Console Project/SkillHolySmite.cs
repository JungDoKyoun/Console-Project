...
{
    internal class SkillHolySmite : Skill
    {
        public SkillHolySmite(string skillName, string skillDescription, int skillDamage, int skillMP) : base(skillName, skillDescription, skillDamage, skillMP)
        {
        }
